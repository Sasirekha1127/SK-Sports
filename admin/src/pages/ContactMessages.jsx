...
export default function ContactMessages() {
  ...
  const toggleRead = async (m) => {
    ...
    await messagesService.markRead(m.id, newReadStatus)
  ...
  const confirmDelete = async () => {
    setDeleting(true)
    try {
      await messagesService.remove(confirmTarget.id)
    ...
    <div>
      <div className="page-head">
        <div>
          ...
          <p>Manage and respond to website enquiries and contact submissions.</p>
        </div>
      </div>
              ...
              filtered.map((m) => (
                ...
                >
                  ...
                  <div className="inbox-item-content">
                    ...
                    <div className="inbox-item-subject">{m.email}</div>
                    <div className="inbox-item-preview">{m.message}</div>
                  </div>
                </div>
              ))
            )}
