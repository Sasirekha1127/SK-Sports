...
export default function EventDetails() {
	...
	const title = eventState.eventTitle || "SK Sports Academy Tournament";
	const date = eventState.eventDate ? eventState.eventDate.toUpperCase() : "OCT 20, 2024";
	const time = eventState.time || "Start 09:00 AM - Until Finish";
	const loc = eventState.loc || "SK Sports Academy Main Court | Pondicherry";
	const price = eventState.price || "₹500";
	const image = (eventState.image && eventState.image.length > 10) ? eventState.image : "images/evtent/evt2.jpg";
					...
					<div className="tf-widget-events">
						<div className="themeflat-container">
							<div className="event-detail-box">
								<h2 className="title-event-detail title-small wow fadeInUp animated ">Badminton Tournaments</h2>
								<div className="detail-box-content" style={{ display: 'flex', flexWrap: 'wrap', gap: '30px', alignItems: 'stretch', marginBottom: '50px' }}>
									<div className="image-event" style={{ flex: '1 1 400px', borderRadius: '16px', overflow: 'hidden', minHeight: '350px' }}>
										<img src={image} alt="Event" className="wow fadeInLeft animated" style={{ width: '100%', height: '100%', objectFit: 'cover' }} onError={(e) => { e.currentTarget.src = 'images/evtent/evt2.jpg'; }} />
									</div>
									<div className="event-detail-card" style={{ flex: '1 1 350px', borderRadius: '16px', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '40px' }}>
										<div className="event-detail-container">
											<h4 className="event-detail-heading">Ticket</h4>
											<p className="price">
												<span>{price}</span>
												<span className="ticket-price">/ entry</span>
											</p>
							...
							<div className="row">
								<div className="col-md-6">
									<div className="event-detail-content">
										<h3 className="wow fadeInUp animated">{title}</h3>
										<p className="post wow fadeInUp animated">SK Sports Academy is delighted to present our exciting {title}. Get ready to embark on a thrilling sporting adventure, where you can connect with a passionate badminton community and experience the full joy of this amazing sport.</p>
										<ul>
								...
								<div className="col-md-6">
									<div className="image-event-content">
										<img src={image} alt="Event" className="wow fadeInRight animated" style={{ width: '100%', objectFit: 'cover', borderRadius: 8 }} onError={(e) => { e.currentTarget.src = 'images/evtent/evt1.jpg'; }} />
									</div>
								</div>
							</div>
						</div>
